...
/*
- Board: phenolic, bakelite
- CPU: vacuum tubes
- RAM: plated-wire memory
- Capacitor: kraft paper, al foil, soywax (aluminium electrolytic capacitor)
- Resistor: carbon pile
- Wiring: annealed copper
...
mods.gregtech.circuit_assembler.recipeBuilder()
    .inputs(metaitem('circuit_board.good'), metaitem('circuit.vacuum_tube') * 2, 
            metaitem('voidrunner:retro_capacitor'), metaitem('voidrunner:plated_wire_memory') * 2,
            metaitem('voidrunner:resistor_carbon_pile'), ore('wireGtSingleAnnealedCopper') * 2)
...
// basic air cooler
// add sintered copper rod variant for 2x output
mods.gregtech.assembler.recipeBuilder()
