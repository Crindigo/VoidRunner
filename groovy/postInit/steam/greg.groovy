...
mods.gregtech.sifter.recipeBuilder()
    ...
    .chancedOutput(item('minecraft:dye', 15), 3500, 750)
    .chancedOutput(metaitem('dustCalcite'), 3500, 750)
    .chancedOutput(metaitem('dustPhosphate'), 9000, 200)
    .chancedOutput(metaitem('dustApatite'), 3500, 750)
    .chancedOutput(metaitem('dustPotash'), 3500, 750)
    .duration(100)
    .EUt(4)
    .buildAndRegister();
